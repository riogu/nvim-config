return {
  ...
  config = function()
    ...
    -- Alternative: Manual cc1plus command if you know the exact flags
    vim.api.nvim_create_user_command('GdbCC1plusDirect', function(opts)
      local cmd = string.format(
        'GdbStart gdb --args ./cc1plus -quiet -std=c++20 '
          .. '-nostdinc++ '
          .. '-isystem ../x86_64-pc-linux-gnu/libstdc++-v3/include '
          .. '-isystem ../x86_64-pc-linux-gnu/libstdc++-v3/include/x86_64-pc-linux-gnu '
          .. '-isystem ../../gcc/libstdc++-v3/libsupc++ '
