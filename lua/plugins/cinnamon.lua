...
-- 1. Plugin Setup (The 'opts' from your old config)
cinnamon.setup({
...
-- 2. Define Keymaps (The 'keys' from your old config)
-- Note: These maps use the cinnamon.scroll() function to enable the animation.
